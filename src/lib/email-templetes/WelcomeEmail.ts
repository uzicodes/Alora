        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" class="main-box" style="border:3px solid #000; background-color:#f2ecaa;">
          <tr>
            <td align="center" style="padding:40px 0 20px 0;">
              <h1 style="margin:0; font-weight:900; text-transform:uppercase; letter-spacing:-2px; font-size:48px; color:#000;">
                <img src="https://aloraa.vercel.app/alora_BG.png" alt="Alora Logo" width="48" height="48" style="vertical-align: middle; margin-right: 10px; display: inline-block;" />
          ...
          <tr>
            <td align="center" style="padding:0 40px;">
              ...
              <h2 style="font-size:20px; margin:0; text-transform:uppercase; color:#000;">Welcome to the World of Best Perfumes</h2>
              <p style="font-size:10px; line-height:24px; color:#333; margin:20px 0;">
          ...
          <tr>
            <td align="center" style="padding:30px 0 40px 0;">
              <a href="https://aloraa.vercel.app/shop" style="background-color:#000; color:#fff; text-decoration:none; padding:15px 35px; font-weight:bold; text-transform:uppercase; font-size:14px; letter-spacing:1px; display:inline-block;">
