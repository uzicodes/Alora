      ...
      <div className="footer-content max-w-[1200px] mx-auto px-6 md:px-10 py-10 grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
        <div className="footer-brand">
          ...
          <div className="mt-3">
            <Link
              href="/admin/login"
              className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-semibold text-gray-400 bg-white/5 hover:bg-white/10 hover:text-white rounded border border-white/10 transition-all"
            >
