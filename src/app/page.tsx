      ...
      <section className="perfume-finder-section">
        ...
        <div className="perfume-grid">
          {[
            ...
            { name: "WINTER WARMTH", desc: "French lavender fields captured in a bottle with honey undertones and powdery violet.", imgs: ["/homepage_images/picks/4/1.png", "/homepage_images/picks/4/2.png", "/homepage_images/picks/4/3.png", "/homepage_images/picks/4/4.png"] },
            { name: "ALL YEAR LONG", desc: "Sun-kissed Sicilian orange zest blended with neroli, warm amber and cedarwood.", imgs: ["/homepage_images/picks/5/1.png", "/homepage_images/picks/5/2.png", "/homepage_images/picks/5/3.png", "/homepage_images/picks/5/4.png"] },
            { name: "BEAT THE SUMMER", desc: "Fresh dewdrop florals meet golden sunlight with notes of bergamot and white tea.", imgs: ["/homepage_images/picks/6/1.png", "/homepage_images/picks/6/2.png", "/homepage_images/picks/6/3.png", "/homepage_images/picks/6/4.png"] },
