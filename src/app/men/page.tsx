...
const menPerfumes = [
  ...
  // Chanel
  { id: "m-4", name: "Bleu de Chanel", brand: "Chanel", category: "Eau de Parfum, 100ml", price: 175, image: "/alora_BG2.png" },
  { id: "m-5", name: "Allure Homme Sport", brand: "Chanel", category: "Eau de Toilette, 100ml", price: 155, image: "/alora_BG2.png" },
  { id: "m-6", name: "Platinum Égoïste", brand: "Chanel", category: "Eau de Toilette, 100ml", price: 145, image: "/alora_BG2.png" },
  // Tom Ford
  { id: "m-7", name: "Ombré Leather", brand: "Tom Ford", category: "Eau de Parfum, 100ml", price: 285, image: "/alora_BG2.png" },
  { id: "m-8", name: "Noir Extreme", brand: "Tom Ford", category: "Eau de Parfum, 100ml", price: 260, image: "/alora_BG2.png" },
  { id: "m-9", name: "Tobacco Vanille", brand: "Tom Ford", category: "Eau de Parfum, 50ml", price: 310, image: "/alora_BG2.png" },
  // Creed
  { id: "m-10", name: "Aventus", brand: "Creed", category: "Eau de Parfum, 100ml", price: 445, image: "/alora_BG2.png" },
  { id: "m-11", name: "Green Irish Tweed", brand: "Creed", category: "Eau de Parfum, 100ml", price: 380, image: "/alora_BG2.png" },
  { id: "m-12", name: "Viking", brand: "Creed", category: "Eau de Parfum, 100ml", price: 395, image: "/alora_BG2.png" },
  // Versace
  { id: "m-13", name: "Eros", brand: "Versace", category: "Eau de Toilette, 100ml", price: 95, image: "/alora_BG2.png" },
  { id: "m-14", name: "Dylan Blue", brand: "Versace", category: "Eau de Toilette, 100ml", price: 90, image: "/alora_BG2.png" },
  { id: "m-15", name: "Pour Homme", brand: "Versace", category: "Eau de Toilette, 100ml", price: 80, image: "/alora_BG2.png" },
  // Paco Rabanne
  { id: "m-16", name: "1 Million", brand: "Paco Rabanne", category: "Eau de Toilette, 100ml", price: 95, image: "/alora_BG2.png" },
  { id: "m-17", name: "Invictus", brand: "Paco Rabanne", category: "Eau de Toilette, 100ml", price: 90, image: "/alora_BG2.png" },
  { id: "m-18", name: "Phantom", brand: "Paco Rabanne", category: "Eau de Toilette, 100ml", price: 105, image: "/alora_BG2.png" },
  // Giorgio Armani
  { id: "m-19", name: "Acqua di Giò", brand: "Giorgio Armani", category: "Eau de Parfum, 125ml", price: 140, image: "/alora_BG2.png" },
  { id: "m-20", name: "Armani Code", brand: "Giorgio Armani", category: "Eau de Toilette, 75ml", price: 110, image: "/alora_BG2.png" },
  { id: "m-21", name: "Stronger With You", brand: "Giorgio Armani", category: "Eau de Parfum, 100ml", price: 125, image: "/alora_BG2.png" },
  // YSL
  { id: "m-22", name: "Y Le Parfum", brand: "YSL", category: "Eau de Parfum, 100ml", price: 145, image: "/alora_BG2.png" },
  { id: "m-23", name: "La Nuit de L'Homme", brand: "YSL", category: "Eau de Toilette, 100ml", price: 130, image: "/alora_BG2.png" },
  { id: "m-24", name: "L'Homme", brand: "YSL", category: "Eau de Toilette, 100ml", price: 120, image: "/alora_BG2.png" },
];
    ...
    <div className="min-h-screen bg-white text-black pb-32 pt-64 font-sans font-body">
      <div className="mx-auto w-full px-6 sm:px-10 md:px-16 lg:px-20">
        <header className="mb-28 text-center">
          <p className="text-[11px] font-body font-medium tracking-[4px] uppercase text-neutral-400 mb-5">
            Curated for Him
          </p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif uppercase tracking-[0.2em] mb-6 text-black">
            Men&apos;s Collection
          </h1>
          <div className="w-12 h-[1px] bg-[#C28D10] mx-auto mt-4"></div>
          <p className="text-sm text-neutral-500 font-light mt-6 max-w-md mx-auto leading-relaxed">
            Discover bold, sophisticated fragrances crafted for the modern gentleman.
          </p>
        </header>
